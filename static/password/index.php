...
<html lang='en'>
  <head>
    ...
    <title>ReFresh Help  :: Change Your Password</title>
  ...
  <body class=''>
    ...
    <div class='row'>
      <div class='medium-12 columns main'>
        ...
        <p class='text-center'>
          <img class='helpimg' src='/assets/ucontrol/UControl-1.png'>
        </p>
        ...
        <p class='text-center'>
          <img class='helpimg' src='/assets/ucontrol/UControl-2.png'>
        </p>
        <p class='text-justify'>
        ...
        <p class='text-center'>
          <img class='helpimg' src='/assets/ucontrol/UControl-3.png'>
        </p>
        <p class='text-justify'>
